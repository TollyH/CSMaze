...
namespace CSMaze
{
    ...
    public class Level
    {
        ...
        public ImmutableHashSet<Point> OriginalExitKeys { get; set; }
        public HashSet<Point> ExitKeys { get; private set; }
        public ImmutableHashSet<Point> OriginalKeySensors { get; set; }
        public HashSet<Point> KeySensors { get; private set; }
        public ImmutableHashSet<Point> OriginalGuns { get; set; }
        public HashSet<Point> Guns { get; private set; }
        public ImmutableDictionary<Point, string> Decorations { get; set; }
        public Point? MonsterCoords { get; set; }
        public Point? MonsterStart { get; set; }
